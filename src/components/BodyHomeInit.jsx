  ...
  return (
    <div className="w-full flex justify-between mt-56 mb-20 px-40">
      <div className="w-1/2 max-w-[700px] space-y-5">
        ...
        <Link to="/cadastro" className="text-white max-w-[270px] rounded-lg border-2 border-transparent flex gap-4 justify-center items-center text-2xl bg-blue-500 font-bold p-3 transition duration-500 ease-in-out  hover:border-current hover:text-white">
